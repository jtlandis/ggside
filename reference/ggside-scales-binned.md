...
of
[scale_x_binned](https://ggplot2.tidyverse.org/reference/scale_binned.html)/[scale_y_binned](https://ggplot2.tidyverse.org/reference/scale_binned.html).
scale_xsidey_binned enables better control on how the y-axis is rendered
on the xside panel and scale_ysidex_binned enables better control on how
the x-axis is rendered on the yside panel.
