...
are geom\_\*abline, geom\_\*hline, and geom\_\*vline.
...
- xintercept, yintercept, slope, intercept:
  ...
  Parameters that control the position of the line specifically for the
  [xside](https://jtlandis.github.io/ggside/reference/xside.md) or
  [yside](https://jtlandis.github.io/ggside/reference/yside.md)
  variants. If these are set, `data`, `mapping` and `show.legend` are
  overridden.
