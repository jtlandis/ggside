...
-   [\#19
    ![](https://img.shields.io/badge/fixed-master-green.svg?style=flat-square)](https://github.com/jtlandis/ggside/issues/19)
    `geom_xsidetext()` is using the incorrect `ggproto` Geometry in its
    layer.
-   [\#20
    ![](https://img.shields.io/badge/fixed-master-green.svg?style=flat-square)](https://github.com/jtlandis/ggside/issues/20)
    `ggplot2::facet_wrap()` and `ggplot2::facet_grid()` will cause
