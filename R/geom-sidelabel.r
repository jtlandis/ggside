...
#' @export
geom_xsidelabel <- ggside_layer_function(fun = geom_label, side = "x", force_missing = c("nudge_x","nudge_y","position"))
...
#' @export
geom_ysidelabel <- ggside_layer_function(fun = geom_label, side = "y", force_missing = c("nudge_x","nudge_y","position"))
