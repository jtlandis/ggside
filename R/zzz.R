...
.onLoad <- function(libname, pkgname){
  register_theme_elements(
    ...
    element_tree = list(ggside.line = el_def("element_line", "line"),
                        ggside.rect = el_def("element_rect", "rect"),
                        ggside.text = el_def("element_text", "text"),
                        ...
                        ggside.panel.background = el_def("element_rect", "ggside.rect"),
                        ggside.panel.border = el_def("element_rect", "ggside.rect"),
