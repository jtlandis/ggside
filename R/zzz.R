...
.onLoad <- function(libname, pkgname){
  register_theme_elements(
    ...
    element_tree = list(ggside.line = el_def("element_line"),
                        ...
                        ggside.panel.grid = el_def("element_line", c("ggside.line","panel.grid")),
                        ggside.panel.grid.major = el_def("element_line", c("ggside.panel.grid", "panel.grid.major")),
                        ...
                        ggside.panel.grid.minor = el_def("element_line", c("ggside.panel.grid", "panel.grid.minor")),
                        ...
                        ggside.xside.panel.grid = el_def("element_line", c("ggside.line","ggside.panel.grid")),
                        ggside.xside.panel.grid.major = el_def("element_line", c("ggside.xside.panel.grid","ggside.panel.grid.major")),
                        ...
                        ggside.xside.panel.grid.minor = el_def("element_line", c("ggside.xside.panel.grid","ggside.panel.grid.minor")),
                        ...
                        ggside.yside.panel.grid.major = el_def("element_line", c("ggside.yside.panel.grid","ggside.panel.grid.major")),
                        ...
                        ggside.yside.panel.grid.minor = el_def("element_line", c("ggside.yside.panel.grid","ggside.panel.grid.minor")),
